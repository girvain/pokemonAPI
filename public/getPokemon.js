...
function createPokeJson(pokemonObj) {
  ...
  //var abilitiesArray = pokemonObj.abilities; 
  //for (var i=0; i < abilitiesArray.length; i++) {
    ////console.log(abilitiesArray[i].ability.name);
    //abilitiesObj.children.push({'name' : abilitiesArray[i].ability.name});
  //}
  //abilitiesObj.name = 'Abilities';

  ////newPokemonObj.children.push(getPokemonAttribute(newPokemonObj, 'moves'));
  //newPokemonObj.children.push(abilitiesObj);

  //console.log(getPokemonAttribute(pokemonObj.abilities));
  

  newPokemonObj.children.push(getPokemonAttribute(pokemonObj.abilities, 'abilities'));
  newPokemonObj.children.push(getPokemonProperty(pokemonObj.base_experience, 'base_experience'));
  ...
  newPokemonObj.children.push(getPokemonAttribute(pokemonObj.game_indices, 'game indices'));
...
function getPokemonAttribute(attribute, name) {
  ...
  //var attributeArray = pokemonObj.attribute; 
  //console.log(attribute);
  for (let i=0; i < attribute.length; i++) {
      //console.log(Object.values(attribute[i]));

    //attributeObj.children.push({'name' : Object.values(attribute[i])[0].name});
...
function getPokemonStats(attribute, name) {
  ...
  for (let i = 0; i < statnode.children.length; i++) {
    ...
    //statnode.children[i].children.push('test');
    //console.log(statnode.children[i].children);
  }
  return statnode;
}
...
function nodeShrinker(attributeObj) {
  // this will be the new object that contains the 4 groups 
  /*var newAttributeObj = {*/
    //name : name,
    //children: []
  //};
...
// the d3.json() converts a json to an array of objects
